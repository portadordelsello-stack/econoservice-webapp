...
const connStrings = [
  'postgresql://postgres.zkoacqpewrsepboswacp:Econoservice1982%2A@aws-0-sa-east-1.pooler.supabase.com:6543/postgres',
  'postgresql://postgres.zkoacqpewrsepboswacp:Econoservice1982%2A@aws-0-us-east-1.pooler.supabase.com:6543/postgres',
  'postgresql://postgres.zkoacqpewrsepboswacp:%5BEconoservice1982%2A%5D@aws-0-sa-east-1.pooler.supabase.com:6543/postgres',
  'postgresql://postgres.zkoacqpewrsepboswacp:%5BEconoservice1982%2A%5D@aws-0-us-east-1.pooler.supabase.com:6543/postgres'
];
...
async function run() {
  ...
  for (const connStr of connStrings) {
    ...
    try {
      ...
      console.warn(`Error al conectar: ${err.message}`);
    }
  }
